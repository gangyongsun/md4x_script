...
# 5.loc操作：通过label（columns和index的名字）来读取数据
...
# 16.对数据进行去重df3中有重复的行数，我们如何将重复的行数去除？
